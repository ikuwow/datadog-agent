...
func setupAPM(config pkgconfigmodel.Setup) {
	...
	config.LoadEnvAsStringSlice("apm_config.features", func(s string) []string {
	...
	config.LoadEnvAsStringSlice("apm_config.ignore_resources", func(in string) []string {
	...
	config.LoadEnvAsStringSlice("apm_config.filter_tags.require", parseKVList("apm_config.filter_tags.require"))
	config.LoadEnvAsStringSlice("apm_config.filter_tags.reject", parseKVList("apm_config.filter_tags.reject"))
	config.LoadEnvAsStringSlice("apm_config.filter_tags_regex.require", parseKVList("apm_config.filter_tags_regex.require"))
	config.LoadEnvAsStringSlice("apm_config.filter_tags_regex.reject", parseKVList("apm_config.filter_tags_regex.reject"))

	config.LoadEnvAsSliceMapString("apm_config.replace_tags", func(in string) []map[string]string {
	...
	config.LoadEnvAsMapStringInterface("apm_config.analyzed_spans", func(in string) map[string]interface{} {
	...
	config.LoadEnvAsStringSlice("apm_config.peer_tags", func(in string) []string {
		var out []string
		if err := json.Unmarshal([]byte(in), &out); err != nil {
