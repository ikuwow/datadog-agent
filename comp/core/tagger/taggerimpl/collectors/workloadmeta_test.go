...
func TestHandleKubePod(t *testing.T) {
	...
	podTaggerEntityID := types.NewEntityID(common.KubernetesPodUID, podEntityID.ID)
	fullyFleshedContainerTaggerEntityID := types.NewEntityID(common.ContainerID, fullyFleshedContainerID)
	noEnvContainerTaggerEntityID := types.NewEntityID(common.ContainerID, noEnvContainerID)
	...
	tests := []struct {
		...
		},
		{
			...
			expected: []*types.TagInfo{
				...
				{
					Source:   podSource,
					EntityID: types.NewEntityID(common.ContainerID, otelEnvContainerID),
					HighCardTags: []string{
	...
	tests := []struct {
	...
	}{
		{
			...
			expected: []*types.TagInfo{
				...
				{
					Source:   podSource,
					EntityID: types.NewEntityID(common.ContainerID, noEnvContainerID),
					HighCardTags: []string{
						fmt.Sprintf("container_id:%s", noEnvContainerID),
						fmt.Sprintf("display_container_name:%s_%s", runtimeContainerName, podName),
					},
...
func TestHandleKubeDeployment(t *testing.T) {
	...
	taggerEntityID := types.NewEntityID(common.KubernetesMetadata, kubeMetadataEntityID.ID)
...
func TestHandleECSTask(t *testing.T) {
	...
	taggerEntityID := types.NewEntityID(common.ContainerID, containerID)
...
func TestHandleContainer(t *testing.T) {
	...
	taggerEntityID := types.NewEntityID(common.ContainerID, entityID.ID)
...
func TestHandleContainerImage(t *testing.T) {
	...
	taggerEntityID := types.NewEntityID(common.ContainerImageMetadata, entityID.ID)
...
func TestHandleDelete(t *testing.T) {
	...
	podTaggerEntityID := types.NewEntityID(common.KubernetesPodUID, podEntityID.ID)
	containerTaggerEntityID := types.NewEntityID(common.ContainerID, containerID)
...
func TestHandlePodWithDeletedContainer(t *testing.T) {
	...
	containerToBeDeletedTaggerEntityID := types.NewEntityID(common.ContainerID, containerToBeDeletedID)
	...
	podTaggerEntityID := types.NewEntityID(common.KubernetesPodUID, pod.ID)
