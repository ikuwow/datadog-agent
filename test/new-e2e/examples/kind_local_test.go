...
func TestMyLocalKindSuite(t *testing.T) {
	e2e.Run(t, &myLocalKindSuite{}, e2eTestMyLocalKindSuite.WithProvisioner(localkubernetes.Provisioner(localkubernetes.WithWorkloadApp(func(e config.Env, kubeProvider *kubernetes.Provider) (*compkube.Workload, error) {
